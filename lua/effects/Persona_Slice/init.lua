...
function EFFECT:Render()
	...
	render.DrawBeam(self.StartPos,self.EndPos,self.Width,math.Rand(0,1),math.Rand(0,1) +((self.StartPos -self.EndPos):Length() /128),Color(self.Colors.x,self.Colors.y,self.Colors.z,(10 /((self.DieTime -0.5) -CurTime()))))
end
/*--------------------------------------------------
	*** Copyright (c) 2012-2020 by DrVrej, All rights reserved. ***
	No parts of this code or any of its contents may be reproduced, copied, modified or adapted,
