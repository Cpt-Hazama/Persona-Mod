...
if CLIENT then
	...
	function ENT:Initialize()
		local c = math.random(1,2) == 1
		self.Theme = c && "cpthazama/persona5/music/boss_adachi_classic.mp3" or "cpthazama/persona5/music/boss_adachi.mp3"
		self.ThemeT = c && 259 or 318
	end
