...
if CLIENT then
	...
	function ENT:Initialize()
		self.Theme = "cpthazama/persona5/music/boss_akechi_crow.mp3"
		self.ThemeT = 123
	end
	...
	net.Receive("vj_persona_hud_akechi_crow",function(len,pl)
		local delete = net.ReadBool()
		local ent = net.ReadEntity()
		hook.Add("HUDPaint","VJ_Persona_HUD_Akechi_Crow",function()
		...
		if delete == true then hook.Remove("HUDPaint","VJ_Persona_HUD_Akechi_Crow") end
	end)
end