...
if CLIENT then
	...
	function ENT:Initialize()
		self.Theme = "cpthazama/persona3/music/boss_yuki.mp3"
		self.ThemeT = 206
	end
	...
	net.Receive("vj_persona_hud_yuki",function(len,pl)
		local delete = net.ReadBool()
		local ent = net.ReadEntity()
		hook.Add("HUDPaint","VJ_Persona_HUD_Yuki",function()
		...
		if delete == true then hook.Remove("HUDPaint","VJ_Persona_HUD_Yuki") end
	end)
end