...
function ENT:OnSummoned(owner)
	...
	self:AddCard("Megidolaon")
	-- self:AddCard("Energy Stream",25,false,"heal")
	self:AddCard("Tentacle of Protection",100,false,"azathoth")
	self:AddCard("Tentacle of Healing",100,false,"azathoth")
	self:AddCard("Tentacle of Assistance",100,false,"azathoth")
