...
ENT.CostumeList = {
	[1] = {Model="models/cpthazama/persona5/ann.mdl",Name="Meta-Verse Form"},
	[2] = {Model="models/cpthazama/persona5/ann_school_winter.mdl",Name="School Uniform (Winter)"},
}
...
if CLIENT then
	...
	function ENT:Initialize()
		self.Theme = "cpthazama/persona5/music/theme_ann.mp3"
		self.ThemeT = 278
	end
	...
	net.Receive("vj_persona_hud_ann",function(len,pl)
		...
		if delete == true then hook.Remove("HUDPaint","vj_persona_hud_ann") end
	end)
end